...
function Main() {
    ...
    return (
        <div>
            <div className='mainBox'>
                <div className="container">
                    <div className="containerDiv">
                        <div>
                            <motion.h1 transition={{ duration: '.20' }} initial={{ x: '-100%', opacity: '0' }}
                                whileInView={{ x: '0px', opacity: '1' }}
                                viewport={{ once: true }} style={{ fontFamily: 'Josefin+Sans' }} className='heading'>Discount Calculator <br /> Online</motion.h1>
                            <motion.p transition={{ duration: '.20', delay: '.10' }} initial={{ x: '-100%', opacity: '0' }}
                                whileInView={{ x: '0px', opacity: '1' }}
            ...
            <motion.div transition={{ duration: '.20', delay: '.20' }} initial={{ x: '-100%', opacity: '0' }}
                whileInView={{ x: '0px', opacity: '1' }}
                viewport={{ once: true }} className="main container shadow">
                <motion.h1 transition={{ duration: '.20', delay: '.20' }} initial={{ x: '-100%', opacity: '0' }}
                    whileInView={{ x: '0px', opacity: '1' }}
                    viewport={{ once: true }} className='discountCalculator'>Instant Discount Calculator</motion.h1>
                <motion.p transition={{ duration: '.20', delay: '.20' }} initial={{ x: '-100%', opacity: '0' }}
                    whileInView={{ x: '0px', opacity: '1' }}
                ...
                <div className="discount">
                    ...
                    <motion.div transition={{ duration: '.20' }} initial={{ x: '400px' }}
                        whileInView={{ x: '10px' }}
